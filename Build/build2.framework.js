...
var ASM_CONSTS = {
  7610424: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 7610479: ($0) => { performance.now = function() { return $0; }; },  
 7610527: ($0) => { performance.now = function() { return $0; }; },  
 7610575: () => { performance.now = Module['emscripten_get_now_backup']; }
};
